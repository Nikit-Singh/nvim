local options = {
  hidden         = true,                    --- don't bother when closing one buffer when we have an unsaved previous buffer
  ...
  timeoutlen     = 2000,                     --- Faster completion (cannot be lower than 200 because then commenting doesn't work)
...
local globals = {
  dashboard_default_executive = ZapVim.plugins.dashboard.fuzzy_plugin, --- Use fuzzy search plugin in dashboard
  fillchars                   = "fold:\\ ", --- Fill chars needed for folds
  mapleader                   = ' ',        --- Map leader key to SPC
}

-- Paste fix (dont make lines after a comment also comments)
